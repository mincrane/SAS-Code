%include '~/CODE/SCOREDIST/scoreformat.sas';
%include '~/CODE/SCOREDIST/score_distribution.sas';
%include '~/CODE/SCOREDIST/scoredist_amt.sas';
%include '~/CODE/SCOREDIST/tier_summary_macro_v2.sas';
libname mraw '.';
