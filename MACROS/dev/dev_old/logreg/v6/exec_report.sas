...
*******************************************************************************************************/
options symbolgen;
%MACRO exec_report(proj_name=, rootdir=, dir=/sas/pprd/austin/operations, num_segs=, event_label=, nonevent_label=);

	libname lrdat "&rootdir./seg1/data/data";
	...
	%sysexec cp "&rootdir./seg1/Final_Stats/Population_Stability/format.csv" "&dir./projects/&project./tracking/Baselines/Development/Population_Stability/.";
	%sysexec mv "&dir./projects/&project./tracking/Baselines/Development/Population_Stability/format.csv" "&dir./projects/&project./tracking/Baselines/Development/Population_Stability/format_seg1.csv";
	
	%sysexec cp "&rootdir./seg1/Final_Stats/Score_distribution/cuts_total.txt" "&dir./projects/&project./tracking/Baselines/Development/Score_distribution/.";
	%sysexec mv "&dir./projects/&project./tracking/Baselines/Development/Score_distribution/cuts_total.txt" "&dir./projects/&project./tracking/Baselines/Development/Score_distribution/cuts_total_seg1.txt";
	
	data _null_;
		set final.iter_matrix(keep=variable) end=eof;
		call symput('pes'!!left(put(_n_,2.)),variable);
		if eof then
	...
	%DO qwe=1 %TO &pes_num;
		...
		%sysexec cp "&rootdir./seg1/Final_Stats/Char_analysis/&&_pes&qwe.._fl_seg1.sas" "&dir./projects/&project./tracking/Baselines/Development/Char_analysis/&&_pes&qwe.._fl_seg1.sas";
	%END;
	
	%sysexec cp "&rootdir./seg1/Final_Stats/Char_analysis/fl_seg1.txt" "&dir./projects/&project./tracking/Baselines/Development/Char_analysis/fl_seg1.txt";
	...
	%DO i=2 %TO &num_segs.;
		...
		%sysexec cp "&rootdir./seg&i./Final_Stats/Population_Stability/format.csv" "&dir./projects/&project./tracking/Baselines/Development/Population_Stability/.";
		%sysexec mv "&dir./projects/&project./tracking/Baselines/Development/Population_Stability/format.csv" "&dir./projects/&project./tracking/Baselines/Development/Population_Stability/format_seg&i..csv";
		
		%sysexec cp "&rootdir./seg&i./Final_Stats/Score_distribution/cuts_total.txt" "&dir./projects/&project./tracking/Baselines/Development/Score_distribution/.";
		%sysexec mv "&dir./projects/&project./tracking/Baselines/Development/Score_distribution/cuts_total.txt" "&dir./projects/&project./tracking/Baselines/Development/Score_distribution/cuts_total_seg&i..txt";
		...
		%DO qwe=1 %TO &pes_num;
			%let _pes&qwe.= %trim(&&pes&qwe.);
			%sysexec cp "&rootdir./seg&i./Final_Stats/Char_analysis/&&_pes&qwe.._fl_seg&i..sas" "&dir./projects/&project./tracking/Baselines/Development/Char_analysis/&&_pes&qwe.._fl_seg&i..sas";
		%END;
		
		%sysexec cp "&rootdir./seg&i./Final_Stats/Char_analysis/fl_seg&i..txt" "&dir./projects/&project./tracking/Baselines/Development/Char_analysis/fl_seg&i..txt";
	...
	filename reports "executive_report.html" mod;
