...
%exec_report(proj_name=Test,rootdir=/sas/pprd/austin/operations/macro_library/dev/test_folders/for_jasmit/ALH,num_segs=2,event_label=Good,nonevent_label=Bad);