  ...
  %ELSE %DO; /*Start performance check BLOCK*/
    ...
    *print score distribution using modified perfgain macro;
    ...
    %END;
	  ...
	  /* Older version of above macro calls */
...
options pagesize=max;
	...
	%char_analysis(variable=&varlist_tot., data_set=lrdat.scrtotal,p_var_=&perfvar.,path_base=&rootdir./Final_Stats/Char_analysis/,fmtfilename_=fl_&segment.,vargen_opt_=yes,require=base);
