...
%include "/sas/pprd/austin/operations/macro_library/dev/logreg/v6_1/logreg_6_1.sas";
...
data dat.seg1_modeling;
    ...
    IF BAD = 1 and pp_gross_mer_next_90d_cap>25 THEN wgt_loss_1k = MAX(LOG(MIN(1000, pp_gross_mer_next_90d_cap)) + 2, 2) ; 
    ELSE IF BAD = 1 and pp_gross_mer_next_90d_cap > 0 THEN wgt_loss_1k = 2 ; 
    ELSE IF BAD = 1 THEN wgt_loss_1k = 2;
    ELSE wgt_loss_1k = 1;

    mod_wgt_1k = sam_wgt * wgt_loss_1k;	

    keep mod_wgt_1k mod_wgt_2 sam_wgt wgt_loss bad pp_gross_mer_next_30d_cap gtpv_next_30d_cap;
...
%logreg(iteration=43,
        rootdir=/sas/pprd/austin/operations/macro_library/dev/test_folders/for_jasmit/ALH/seg1,
        datadir=,                                      
