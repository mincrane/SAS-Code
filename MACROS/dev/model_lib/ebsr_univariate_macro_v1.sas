...
%IF %sysfunc(exist(curr.&datout._numeric)) = 1 or %sysfunc(exist(curr.&datout._char))= 1 %THEN %DO;
proc datasets lib = curr;
	delete &datout._numeric &datout._char &datout._char_gt30;
run;
%END;
...
proc append base = curr.&datout._numeric data = univ_num;
run; 
...
data univ_char;
	length varname $25 ks ival num_record group missing pct_miss 8 c1 $10 p1 8 c2 $10 p2 3  c3 $10 p3 3 c4 $10 p4 3 c5 $10 p5 3;
	varname = "&var_char.";
	ks = &ks;
	ival = &iv;
	num_record = &totalobs;
...
%else %do;
data univ_char_gt30;
	lenght varanme $25 num_record group missing pct_miss 8;
	varname = "&var_char.";
	num_record = &totalobs;
	group = &numgroup;
	missing = &num_miss;
...
PROC PRINT DATA=curr.&datout._numeric SPLIT='*' noobs;
      VAR  varname drop_flag ks ival n wgtN nmiss pct_miss mean min p1 p5 p10 p20 p30 p40 p50 p60 p70 p80 p90 p95 p99 max / style={just=l};
      LABEL  varname = "VARIABLE" drop_flag="DROP *FLAG" KS= 'KS  ' ival='Information*Value' n = 'Num' wgtn = 'Weighted *Num' nmiss = '# of Missing' pct_miss = 'Pct Missing'
             mean = 'MEAN' min = 'MIN' p1 = 'P1' p5 ='P5' p10 = 'P10' p20 = 'p20' p30 = 'P30' p40 = 'P40' p50 = 'P50' p60 = 'P60' p70 = 'P70' p80 = 'P80' p90 = 'P90' p95 = 'P95' p99 = 'P99'
             max = 'MAX';			 
      FORMAT n wgtn 9.0;
      FORMAT pct_miss ival 5.3;
      FORMAT ks 8.1;
...
PROC PRINT DATA=curr.&datout._char SPLIT='*' noobs;
      VAR  varname ks ival num_record group missing pct_miss c1 p1 c2 p2 c3 p3 c4 p4 c5 p5 / style={just=l};
      LABEL  varname = "VARIABLE" KS= 'KS    ' ival='Information*Value' num_record = 'Num' group = 'GROUP' missing = 'NMISS' pct_miss = 'Pct Missing' C1 = 'CAT1' P1 = 'FREQ1'
...
PROC PRINT DATA=curr.&datout._char_gt30 SPLIT='*' noobs;
      VAR  varname num_record group missing pct_miss ;
      LABEL  varname = "VARIABLE" num_record = 'Num' group = 'GROUP' missing = '# of MISS' pct_miss = 'Pct Missing' ; 
